...
data_q$Model <- factor(data_q$Model, levels = c("CR2MET - C","CR2MET - V", "ERA5 - C", "ERA5 - V", "MSWEP - C", "MSWEP - V","PMET - C", "PMET - V"))
...
y3 <- list(title = "Variability (γ)", titlefont = f, range = c(0.5, 1.5),
           tickfont = f2, dtick = 0.25, ticks = "outside", zeroline = FALSE)
