...
server <- orca_serve()
server$export(fig, file = "Figure7_Validation_v2.pdf", width = 1200, height = 1000, scale = 4)
server$export(fig, file = "Figure7_Validation_v2.png", width = 1200, height = 1000, scale = 4)
server$close()
