...
t2m_obs      <- sweep(t2m_obs[,-1], 2, (t2m_shape$Altitude_lr - t2m_shape$Altitude)*0.0065)
...
t2m_stacks <- list(ERA5  = rast("Tavg_ERA5_1959_2021m.nc"),    # ERA5 
                  ...
                  CR2MET = rast("Tavg_CR2MET_1979_2020m.nc"),   # CR2MET v2.0 
...
write.csv(t2m_validation, "Tavg_Validation.csv")