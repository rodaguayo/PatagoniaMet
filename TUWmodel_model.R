...
for (i in 1:83) {
    if (areas$nbands[i] != 0){
      ...
      pp_i<-read.table(paste0("C:/Users/rooda/Dropbox/Rstudio/TUWmodel/CR2MET/PP/PP_gridcode_", sprintf("%03d", i),".csv"), sep = ",", row.names=1, header = TRUE)
      t2m_i<-read.table(paste0("C:/Users/rooda/Dropbox/Rstudio/TUWmodel/CR2MET/T2M/T2M_gridcode_", sprintf("%03d", i),".csv"), sep = ",", row.names=1, header = TRUE)
      pet_i<-read.table(paste0("C:/Users/rooda/Dropbox/Rstudio/TUWmodel/CR2MET/PET/PET_gridcode_", sprintf("%03d", i),".csv"), sep = ",", row.names=1, header = TRUE)
  ...
  write.csv(KGE, "Q_performance_CR2MET.csv")
